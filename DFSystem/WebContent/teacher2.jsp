...
</script><jsp:useBean id="classDao" class="dao.ClassesDatabaseDao" scope="page"></jsp:useBean>
<%
...
<script type="text/javascript">
	function change() {
		...
		var str = "/DFSystem/teacher2.jsp?id=" + stuid + "&cursId=00" + index+ "&classId=00" +classname;
...
<body>
	...
	<div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-brand" href="/DFSystem/zunei.jsp">打分系统 - 查看打分</a>
	...
	<div class="centerinput">
		...
		<div id="zu1">
			...
			<div id="zu<%=i%>1" style="display:none;">
				...
				<form
						action="StudentServlet?method=12&id=<%=request.getParameter("id")%>&classId=<%=request.getParameter("classId")%>
