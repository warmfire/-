...
<script type="text/javascript">
	function change() {
		...
		var str = "/DFSystem/zujian.jsp?id=" + stuid + "&cursId=00" + id;
...
<body>
	...
	<div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-brand"
				href="/DFSystem/zunei.jsp?id=<%=request.getParameter("id")%>&cursId=001">打分系统 - 组间打分</a>
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="/DFSystem/zujian2.jsp?id=<%=request.getParameter("id")%>&cursId=<%=request.getParameter("cursId")%>">查看打分</a></li>
						<li><a
	...
	<form method="post" name="zujian">
		...
		<ul class="pager">
			<li><a
				href="/DFSystem/zunei.jsp?id=<%=request.getParameter("id")%>&cursId=<%=request.getParameter("cursId")%>">组内打分</a></li>
			<div class="btn-group">
		...
		<div class="centerinput">
			...
			<div id="zu">
				...
				<div id="zu<%=i%>1" style="display: none;">
					...
					<form
						action="StudentServlet?method=8&id=<%=request.getParameter("id")%>
