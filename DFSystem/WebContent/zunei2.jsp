...
<%
	...
	igm.setGrader(request.getParameter("id"));
...
<script type="text/javascript">
	function change(){
		...
		var str = "/DFSystem/zunei2.jsp?id="+stuid+"&cursId=00"+id;
...
<body>
	...
	<div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-brand"
				href="/DFSystem/zunei.jsp?id=<%=request.getParameter("id")%>&cursId=001">打分系统 - 查看打分</a>
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="/DFSystem/zunei.jsp?id=<%=request.getParameter("id")%>&cursId=<%=request.getParameter("cursId")%>">返回</a></li>
	...
	<form action="StudentServlet?method=10&id=<%=request.getParameter("id")%>&cursId=<%=request.getParameter("cursId")%>" method="post" name="zunei">
		<nav>
		<ul class="pager">
			<li><a
				href="/DFSystem/zujian.jsp?id=<%=request.getParameter("id")%>">组间打分</a></li>
			<div class="btn-group">
		...
		<div class="centerinput">
			<div class="input-group">
				...
				<div class="inputTitle_short">自评分100%</div>
				<div class="inputTitle_short">互评分100%</div>
			</div>
			<div class="input-group">
					<%
					...
					%> 
						...
						class="inputgrades_short" value=<%= ig.getSelfgrades() %>
						aria-describedby="basic-addon1"> 
						<input type="text" name="<%= ig.getStuId() %>allgrades" 
						class="inputgrades_short" value=<%= ig.getAllGrades() %>
						aria-describedby="basic-addon1"> 
					<%
 						}
 					%> 				
