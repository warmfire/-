...
<script type="text/javascript">
	function selectcurs() {
		...
		if (document.add.groupid.value.length == 0) {
...
<body>
	...
	<nav class="navbar navbar-default navbar-static-top">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="/DFSystem/teacher.jsp?id=<%= request.getParameter("id")%>">打分系统 - 选择课程</a>
			</div>
	...
	<div id="login-bg">
		<div id="login-cell">
		<form  action = "StudentServlet?method=5&id=<%= request.getParameter("id")%>" method = "post" name="add">
						
			<div class="btn-group">
			    <select name="course" width="100" class="btn btn-default dropdown-toggle">
	                 <option>- 请选择课程 -</option>
	                 <%
			...
			<div class="input-group btn-block">
				<input id="mm" type="text" class="form-control" placeholder="组别"
					aria-describedby="basic-addon1"  name="groupid">
			</div>
			<div id="mm-w" class="alert alert-danger" role="alert"
				style="display: none;">请输入组别</div>	
			
			<div><span >是否为组长：</span>
				<select name="isleader" width="100">
